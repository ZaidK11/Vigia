...
const PORTAL_ROLES = {
  dashboard: ['LEADERSHIP', 'TM_ANALYST', 'FRAUD_INVESTIGATOR', 'KYC_ANALYST', 'SUPPORT_ANALYST'],
  support: ['SUPPORT_ANALYST', 'FRAUD_INVESTIGATOR', 'KYC_ANALYST', 'TM_ANALYST', 'LEADERSHIP'],
